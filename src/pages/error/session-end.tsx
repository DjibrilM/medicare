  ...
  return (
    <div className="mi-h-screen w-full">
      <div className="px-4 py-3 max-w-[600px] bg-white border border-blue-gray-100 m-auto mt-20 text-center flex-col flex justify-center">
        ...
        <Link
          className="flex w-full mt-6 items-center justify-center gap-3.5 rounded-lg border border-stroke bg-primary text-white p-4 hover:bg-opacity-80 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-50"
          to={"/auth/signin"}
        >
          signin
        </Link>
